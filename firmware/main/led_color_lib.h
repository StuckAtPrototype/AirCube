 ...
 * based on a step value. The step value determines the position
 * in the gradient (0 = green, 255 = red).
 * 
 ...
 * 
 * This function applies an intensity multiplier to a color value.
 * The intensity is specified as a value from 0.0 (off) to 1.0 (full brightness).
 * 
 * @param color Base color value in GRB format
 * @param intensity Intensity value (0.0 to 1.0)
 * @return 24-bit GRB color value with applied intensity
 */
